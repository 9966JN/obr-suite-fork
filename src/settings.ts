...
const IMPORTANT_NOTES: BilingualHtml = {
  zh: `
    ...
    <div class="step">
      ...
      <img src="/owner-step1.png" alt="Players 面板的盾牌按钮">
      <p>展开 Map → <b>Character</b> 行，在下拉里勾上 <b>Owner Only</b>，然后 SAVE。</p>
      <img src="/owner-step2.png" alt="勾选 Owner Only">
    ...
    <div class="step">
      ...
      <img src="/owner-step3.png" alt="角色工具栏的 Set Owner 按钮">
  ...
  en: `
    ...
    <div class="step">
      ...
      <img src="/owner-step1.png" alt="Shield button in Players panel">
      <p>Expand Map → <b>Character</b> row, select <b>Owner Only</b> in the dropdown, then SAVE.</p>
      <img src="/owner-step2.png" alt="Select Owner Only">
    ...
    <div class="step">
      ...
      <img src="/owner-step3.png" alt="Set Owner button on token toolbar">
